...
SVC_NAME="actions.runner.yhyakuna-vault-action-exampleapp.Yokos-MacBook-Pro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (yhyakuna-vault-action-exampleapp.Yokos-MacBook-Pro)"
